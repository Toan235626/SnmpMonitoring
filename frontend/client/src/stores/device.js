    ...
    actions: {
        ...
        async performAction(action, deviceId, params) {
            ...
            try {
                ...
                const community =
                    device.community || params.community || 'public';
                ...
                if (params.version === '3' && !params.authUsername) {
                ...
                if (
                    ...
                    throw new Error(
                        'SNMPv3 authNoPriv or authPriv requires authPass and authProtocol'
                    );
                }
                if (
                    params.version === '3' &&
                    ...
                    throw new Error(
                        'SNMPv3 authPriv requires privPass and privProtocol'
                    );
                }
                ...
                switch (action) {
                    case 'get':
                        ...
                        processResponse = (response) => {
                            ...
                            this.results[deviceId] = response.data.map(
                                (item) => ({
                                    oid: item.oid,
                                    value: item.value,
